...
wget https://github.com/minbrowser/min/releases/download/v1.30.0/min-1.30.0-amd64.deb

printf "Convirtiendo paquete \n"
./xdeb -Sde min-1.30.0-amd64.deb

printf "Instalando \n"
sudo xbps-install -R binpkgs min-1.30.0_1
